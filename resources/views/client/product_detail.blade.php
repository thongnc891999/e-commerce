        ...
        <div class="product-detail">
            <div class="product-detail__left">
                ...
                <div class="product-detail__left--bottom">
                    ...
                    <a href="#" class="product-detail__left--item">
                        <img src="{{asset('img/spx2/spx2-12.png')}}" alt="" class="product-detail__left--img">
                    </a>
                    <a href="#" class="product-detail__left--item">
                        <img src="{{asset('img/spx2/spx2-13.png')}}" alt="" class="product-detail__left--img">
                    </a>
                    <a href="#" class="product-detail__left--item">
                        <img src="{{asset('img/spx2/spx2-14.png')}}" alt="" class="product-detail__left--img">
                    </a>
